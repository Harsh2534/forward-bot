...
class Config:
    ...
    PICS = (environ.get('PICS', 'https://graph.org/file/0493dbab95964364e4264.jpg'))
    ...
    FORCE_SUB_CHANNEL = environ.get("FORCE_SUB_CHANNEL", "https://t.me/MoviesUpdate_07") # FORCE SUB channel link 
