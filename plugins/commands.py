...
main_buttons = [[
        InlineKeyboardButton('🦋 ᴜᴘᴅᴀᴛᴇs ', url='https://t.me/MoviesUpdate_07'),
        InlineKeyboardButton(' sᴜᴘᴘᴏʀᴛ ✨', url='https://t.me/MoviesUpdate_chat')
        ],[
...
async def about(bot, query):
    await query.message.edit_media(
        media=InputMediaPhoto(
        media="https://graph.org/file/0493dbab95964364e4264.jpg",
